...
#echo "design, cpu_time, gpu_time, cpu50, gpu50, cpu100, gpu100, cpu200, gpu200, cpu300, gpu300, cpu400, gpu400, cpu500, gpu500, cpu600, gpu600, cpu700, gpu700 " > ./data/hybrid.dat
#echo "design, gpu, gpu50, gpu100, gpu200, gpu300, gpu400, gpu500, gpu600, gpu700" > ./data/hybrid_speedup.dat
...
for DESIGN in poly poly6 diode level1_linear level1_satur approx1 bellido poly8 approx2 caprasse
do
